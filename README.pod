...
Added support for dashes in GitHub usernames. Thanks L<Pedro Figueiredo|https://github.com/pfig>!
...
MacOS with perl 5.42.0 and OpenSSH 10.2.
...
L<agnosticlines|https://github.com/agnosticlines>:
L<GitHub #65|https://github.com/dolmen/github-keygen/pull/65>
and hints about macOS SEC.

=back

If you want to contribute, have a look at L<CONTRIBUTING.pod>.


=head1 COPYRIGHT & LICENSE

Copyright E<copy> 2011-2026 Olivier MenguE<eacute>.
