...
On key creation, custom key comment provided by -C was ignored
(L<GitHub #46|https://github.com/dolmen/github-keygen/issues/46>). This is fixed.
Thanks to L<@tinhtruong|https://github.com/tinhtruong> for the report.
