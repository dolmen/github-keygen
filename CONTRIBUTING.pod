...
=item 1. Setup a Perl development environment
...
=item b. Setup environment to install Perl modules from CPAN using cpanm.
...
=item 5.2. Link your local repo to your fork (just once)
...
=item 6.2 Submit a pull request on GitHub
